...
<html>
    ...
    <script type="text/javascript">
        $(function () {
          	var name = document.getElementById("nameMesg");

                //绑定用户名框的失去焦点事件
                $("#username").blur(function () {

                    $.ajax({
                        url:"userServlet?methodName=checkUser",
...
<div class="row"> 
	...
	<div class="col-md-8" style="background:#fff;padding:40px 80px;margin:30px;border:7px solid #ccc;">
		...
		<form action="userServlet?methodName=register" method="post" class="form-horizontal" style="margin-top:5px;">
			 <div class="form-group">
			    <label for="username" class="col-sm-2 control-label">用户名</label>
			    <div class="col-sm-6">
			      <input type="text" class="form-control" id="username" name="userName" placeholder="请输入用户名">
                    <span id="nameMesg" style="float: left"></span>
			    </div>
			  </div>
			   <div class="form-group">
