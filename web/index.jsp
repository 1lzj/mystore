...
<html>
	...
	<head>
		...
		<script type="text/javascript">
			$(function () {
				$.ajax({
					url:"productServlet?methodName=hostList",
					type:"get",
					dataType:"json",
					success:function (data) {
						var firstProduct = data[0];
						$("#bigProduct").attr("src",firstProduct.pimage);
						$("#bighref").attr("href","productServlet?methodName=findProductById&pid="+firstProduct.pid);
						for(var i=1;i<data.length;i++){
						    var divNode = "\t<div class=\"col-md-2\" style=\"text-align:center;height:200px;padding:10px 0px;\">\n" +
                                "\t\t\t\t\t\t<a href=\"productServlet?methodName=findProductById&pid="+data[i].pid +"\">\n" +
                                "\t\t\t\t\t\t\t<img src=\""+ data[i].pimage+"\" width=\"130\" height=\"130\" style=\"display: inline-block;\">\n" +
                                "\t\t\t\t\t\t</a>\n" +
                                "\t\t\t\t\t\t<p><a href=\"productServlet?methodName=findProductById&pid="+data[i].pid +"\" style='color:#666'>"+data[i].pname +"</a></p>\n" +
                                "\t\t\t\t\t\t<p><font color=\"#E4393C\" style=\"font-size:16px\">&yen;"+ data[i].shopPrice+"</font></p>\n" +
                                "\t\t\t\t\t</div>"
							$("#hostList").append(divNode)
	...
	<body>
		<div class="container-fluid">
			...
			<div class="container-fluid">
				...
				<div class="col-md-10" id="hostList">
					<div class="col-md-6" style="text-align:center;height:200px;padding:0px;" >
						<a href="" id="bighref">
							<img id="bigProduct" src="products/hao/middle01.jpg" width="516px" height="200px" style="display: inline-block;">
						</a>
					</div>
