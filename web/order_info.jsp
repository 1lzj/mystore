...
<html>
	...
	<body>
		...
		<div class="container">
					...
					<table class="table table-bordered">
						<tbody>
							...
							<tr class="active">
								...
								<td width="15%">
									<span class="subtotal">￥${map.value.total}</span>
								</td>
							</tr>
							</c:forEach>
						</tbody>
			...
			<div>
				<hr/>
				<form class="form-horizontal" style="margin-top:5px;margin-left:150px;" id="orderForm" method="post" action="oderServlet">
					<input type="hidden" name="methodName" value="addOrder">
					<input type="hidden" name="oid" value="${sessionScope.oid}">
