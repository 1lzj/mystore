...
<html>
	...
	<jsp:include page="/include/header.jsp"/>
		...
		<div class="row" style="width:1210px;margin:0 auto;">
			...
			<c:forEach items="${requestScope.pageBean.list}" var="p">
				<div class="col-md-2">
					<a href="productServlet?methodName=findProductById&pid=${p.pid}">
						<img src="${p.pimage}" width="170" height="170" style="display: inline-block;">
					</a>
					<p><a href="productServlet?methodName=findProductById&pid=${p.pid}" style='color:green'>${p.pname}</a></p>
				...
				<li class="disabled"><a href="#" aria-label="Previous"><span aria-hidden="true">&laquo;</span></a></li>
					<c:forEach var="i" begin="1" end="${pageBean.total}">
						<li <c:if test="${requestScope.pageBean.pageNo==i}"> class="active" </c:if>>
							<a href="productServlet?methodName=findByCid&cid=${requestScope.cid}&pageNo=${i}">${i}</a>
						</li>
					</c:forEach>
